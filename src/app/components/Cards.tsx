...
import imgage from "../assets/images/Genmaicha.jpg"
  ...
  return (
    <>
        <div className={`w-fit flex flex-col rounded-lg transition-all duration-100 ease-in-out shadow-md shadow-black/30 bg-slate-100 m-2 shadow- ${className}`}>
            {imgage && <Image className="rounded-t-md object-cover aspect-square max-h-[210px] max-w-[210px]" src={imgage} alt={heading} /> }
